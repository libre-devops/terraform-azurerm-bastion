...
The smallest valid call: a Developer bastion (the free default) attached to a vnet with one
attribute. No AzureBastionSubnet, no public IP, no scale units. The environment comes from the
